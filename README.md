...
An ultra-lightweight and non-blocking Arduino/ESP32 framework to interface with a Geiger-Müller radiation counter tube. This code serves as a clean hardware-abstracted foundation for more advanced projects like Radiation Monitors (CPM/µSv/h) or True Random Number Generators (TRNG).
